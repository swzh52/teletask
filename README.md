...
- 同一关键词触发存在 **5 秒冷却**，防止高频刷屏（不同群组冷却互不影响）
...
- 记录上传者姓名、用户名、ID
- 支持**在线编辑文件名**、**软删除**文件
- 删除前自动检查引用，被删除文件若仍被关键词或任务使用，Bot 跳过发送并告警管理员
...
| 版本 | 日期 | 主要更新 |
|------|------|---------|
| v1.3.2 | 2026-04-12 | 删除定时任务生效时间、修复勾选框、修复关键词定时启用、数据库写锁 |
| v1.3.1 | 2026-04-11 | 4 项 bug 修复、6 项安全修复 |
| v1.3.0 | 2026-04-11 | 批量操作、关键词开始生效时间 |
| v1.2.1 | 2026-04-10 | 9 项 bug 修复、Cookie 安全加固 |
| v1.2.0 | 2026-04-10 | 自动删除消息、关键词到期、HTML 富文本、自动 Ban、文件库管理 |
| v1.0.0 | 2026-04-10 | 初始发布 |
